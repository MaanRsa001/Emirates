...
public class WSExceptionBean  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    private com.iii.premia.maansarovar.services.marinedirect.MarineDirectFault errorDetails;

    public WSExceptionBean() {
    }

    public WSExceptionBean(
           com.iii.premia.maansarovar.services.marinedirect.MarineDirectFault errorDetails) {
     ...
     * @return errorDetails
     */
    public com.iii.premia.maansarovar.services.marinedirect.MarineDirectFault getErrorDetails() {
        return errorDetails;
    }
     ...
     * @param errorDetails
     */
    public void setErrorDetails(com.iii.premia.maansarovar.services.marinedirect.MarineDirectFault errorDetails) {
        this.errorDetails = errorDetails;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://marinedirect.services.maansarovar.premia.iii.com/", "WSExceptionBean"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("errorDetails");
        elemField.setXmlName(new javax.xml.namespace.QName("", "ErrorDetails"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://marinedirect.services.maansarovar.premia.iii.com/", "marineDirectFault"));
