		...
		try {
			...
			String sql = "INSERT INTO payment_detail (" +
 			...
 			String args[]=new String[] {
					...
					resultMap.get("NAME").toString().length()>55?resultMap.get("NAME").toString().substring(0, 55):resultMap.get("NAME").toString(),
					resultMap.get("NAME").toString().length()>55?resultMap.get("NAME").toString().substring(0, 55):resultMap.get("NAME").toString(),
					resultMap.get("NAME").toString().length()>55?resultMap.get("NAME").toString().substring(0, 55):resultMap.get("NAME").toString(),				
					resultMap.get("ADDRESS")==null?"NA":resultMap.get("ADDRESS").toString().length()>55?resultMap.get("ADDRESS").toString().substring(0, 55):resultMap.get("ADDRESS").toString(),
