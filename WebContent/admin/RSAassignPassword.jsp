...
<%
	String[][] brokers=broker.getRSAAdmins(actualBranch,(String)session.getAttribute("usertype"));
%>
...
<td width="144" align="left"></td> </tr>  </td>   </tr>
...
<tr> 
                              ...
                              <td width="144" align="left">
							   ...
							   <td width="38%" align="right" colspan="2">(min 7 chars with a number and a lower case letter)</td>
                            </tr>
							<tr> 
...
function posting()
{
	document.form1.action="RSAassignPassword.jsp"
