		        		...
		        		<td bgcolor="#FFFFFF" style="padding:10px; background:#F8F8F8">
								<s:form name="form1" theme="simple">
							 		<table width="100%" align="center">
								        <tr>
								            <td class="heading" width="100%"><s:text name="label.broker.selection"/></td>
								        </tr>
								 		<tr>
								        	<td height="10%">
								        		&nbsp;
							      		...
							      		<tr>
							      			<td>
										      	<display:table name="brokerList" requestURI="brokerSelectionAdmin.action" pagesize="" class="table" uid="row" id="record">
													...
													<display:column headerClass="sortable" sortable="true" style="text-align:center;" title="<input type='checkbox'  onclick='SelectAll()' id='checkall' />">
														 <input type="checkbox"  value="${record.AGENCY_CODE}" id="checkbox${record.AGENCY_CODE}" />
													</display:column>
													<display:column headerClass="sortable" sortable="true" style="text-align:left;" title="Broker Name" property="COMPANY_NAME" />
												</display:table>
											</td>
										</tr>
