								...
								<s:form id="info" name="underwriter" method="post" action="updateIncludeUnderwriterMgm" theme="simple">
									<table width="100%"  border="0" cellspacing="0" cellpadding="0">
										...
										<tr> 
											...
											<td width="1"></td> 
											<td width="100%" class="heading"><strong>INCLUDED BROKER</strong></td>
										</tr> 
										<tr align="center"> 
											<td colspan="3">&nbsp;</td> 
										</tr> 
										<tr align="center"> <td colspan="3" style="color:red;"><s:actionerror/>
										...
										<td bgcolor="#FFFFFF" style="padding:10px; background:#F8F8F8" align="center" width="100%">
																		...
																		<display:table name="excludeIssuer" pagesize="20" requestURI="/excludeIssuerUnderwriterMgm.action" class="footable" uid="row" id="record">
																			...
																			<s:checkboxlist name="status[%{#attr.record_rowNum-1}]" list="#{'include':''}" />
