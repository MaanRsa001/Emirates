    ...
    <div class="easyui-layout" style="width:900px;height:1000px;">
        ...
        <div data-options="region:'center',title:'',iconCls:''">
            <div class="easyui-tabs" data-options="fit:true,border:false,plain:true" id="mainTab">
                <div title="Travel Option" style="padding:5px">
							...
							<s:if test ="display==null or display == ''">
								<s:form name="form1" theme="simple">
							 		<table width="100%" align="center">
								        <tr>
								            <td class="heading" width="100%"><s:text name="travel.option"/></td>
								        </tr>
								 		<tr>
								        	<td height="10%">
								        		&nbsp;
							        	...
							        	<tr><td>
								      	<display:table name="list" pagesize="10"  requestURI="${pageContext.request.contextPath}/optionTravelConfigure.action" class="table" uid="row" id="record" style="align:center; " cellpadding="1" cellspacing="1"  varTotals="totals" >
										...
										<display:column sortable="true"	style="text-align:center;width:10%" title="History" >
		                    					<a href="#" onclick="return popUp('${pageContext.request.contextPath}/optionTravelConfigure.action?display=history&optionId=${record.OPTION_ID}','400','350');">View</a>
										</display:column>
										<display:column sortable="true" style="text-align:center;" title="Edit"  >
												<input type="button" name="reset" value="Edit" onclick="return fnsubmit(this.form,'edit','${record.OPTION_ID}');" class="btn" />
										</display:column>
										</display:table>
										</td></tr>
										<tr><td align="center">
							 			...
							 			<tr>
							 				<td>
							  					<table width="100%" align="center" cellpadding="4" border="0">
							  						<tr>
								                        <td class="heading" colspan="2"><s:text name="travel.option"/></td>
								                        <td>&nbsp;</td>
								                    </tr>
							                        <tr>
								                         <td><s:text name="travel.option.name" /><font color="red">*</font></td>
								                         <td><s:textfield name="optionName" id="optionName" cssClass="input" /></td>
								                    </tr>
							                        <tr>
								                         <td><s:text name="travel.core.app.code" /><font color="red">*</font></td>
								                         <td><s:textfield name="optionCode" id="optionCode" cssClass="input" /></td>
								                    </tr>
							                        <tr>
								                         <td><s:text name="travel.choose.product" /><font color="red">*</font></td>
								                         <td><s:select name="optionProduct" id="optionProduct" list="#{'33':'Travel Insurance Walla'}" headerKey="" headerValue="-Select-" cssClass="input" /></td>
								                    </tr>
							                        <tr>
							                             <td><s:text name="travel.effectivedate" /><font color="red">*</font></td>
		                            					 <td><s:textfield name="optionDate"  readonly="true" id="effectiveDt"/></td>
								                    </tr>
									        		<tr>
								                         <td><s:text name="travel.status" /><font color="red">*</font></td>
								                         <td><s:radio list="#{'Y':'Active','N':'DeActive'}" name="optionStatus" id="optionStatus" value="%{optionStatus==null?'N':optionStatus}" cssClass="input2"/></td>
								                    </tr>
								   	  			</table>
							      	  		</td>
							      	  	</tr>
							...
							<s:elseif test="'history'.equalsIgnoreCase(display)">
								<s:form name="form1" theme="simple">
							 		<table align="center" width="100%">
								        <tr>
								            <td class="heading" ><s:text name="travel.option"/></td>
								        </tr>
								 		<tr>
								        	<td height="10%">
								        		&nbsp;
...
{
if(from == 'edit'){
document.form1.action = "${pageContext.request.contextPath}/optionTravelConfigure.action?optionId="+val+'&display='+from;
}else{
document.form1.action = "${pageContext.request.contextPath}/optionTravelConfigure.action?display="+from;
}
