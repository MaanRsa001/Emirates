    ...
    <div class="easyui-layout" style="width:900px;height:1000px;">
        ...
        <div data-options="region:'center',title:'',iconCls:''">
            <div class="easyui-tabs" data-options="fit:true,border:false,plain:true" id="mainTab">
                <div title="Premium Rate" style="padding:5px">
							...
							<s:if test ="display==null or display == ''">
								<s:form name="form1" theme="simple">
							 		<table width="100%" align="center">
								        <tr>
								            <td class="heading" width="100%"><s:text name="travel.premiumrate"/></td>
								            <td>&nbsp;</td>
								        </tr>
								 		<tr>
								        	<td height="10%">&nbsp;</td>
							        	...
							        	<tr>
			  							...
			  							<tr><td>
								      	<display:table name="list" pagesize="10"  requestURI="${pageContext.request.contextPath}/premiumrateTravelConfigure.action" class="table" uid="row" id="record" style="align:center; " cellpadding="1" cellspacing="1"  varTotals="totals" >
										...
										<display:column sortable="true" style="text-align:center;" title="No of Days" property="NO_OF_DAYS"/>
										<display:column sortable="true" style="text-align:center;" title="Scheme Name" property="SCHEME_NAME"/>
										<display:column sortable="true" style="text-align:center;" title="Option Name" property="OPTION_NAME"/>
										<display:column sortable="true" style="text-align:center;" title="Premium" property="PREMIUM"/>
										...
										<display:column sortable="true"	style="text-align:center;width:10%" title="History" >
		                    					<a href="#" onclick="return popUp('${pageContext.request.contextPath}/premiumrateTravelConfigure.action?display=history&disId=${record.TRAVEL_PREMIUM_ID}','400','350');">View</a>
										</display:column>
										<display:column sortable="true" style="text-align:center;" title="Edit"  >
												<input type="button" name="reset" value="Edit" onclick="return fnsubmit(this.form,'edit','${record.TRAVEL_PREMIUM_ID}');" class="btn" />
										</display:column>
										</display:table>
										</td></tr>
										<tr><td align="center">
							 			...
							 			<tr>
							 				<td>
							  					<table width="100%" align="center" cellpadding="4" border="0">
							  						<tr>
								                        <td class="heading" colspan="2"><s:text name="travel.premiumrate"/></td>
								                        <td>&nbsp;</td>
								                    </tr>
								                     <tr>
								                         <td><s:text name="Scheme Name" /><font color="red">*</font></td>
								                         <td><s:select name="schemeName" id="schemeName" list="#{'schengen':'Schengen'}" headerKey="" headerValue="-Select-" cssClass="input" /></td>
								                    </tr>
								                    <tr>
								                         <td><s:text name="Option Name" /><font color="red">*</font></td>
								                         <td><s:textfield name="optionName" id="optionName" cssClass="input" /></td>
								                    </tr>
								                    <tr>
								                         <td><s:text name="No. of Days" /><font color="red">*</font></td>
								                         <td><s:textfield name="noofDays" id="noofDays" cssClass="input"  /></td>
								                    </tr>
							                        <tr>
...
{
if(from == 'edit'){
document.form1.action = "${pageContext.request.contextPath}/premiumrateTravelConfigure.action?disId="+val+'&display='+from;
}else{
document.form1.action = "${pageContext.request.contextPath}/premiumrateTravelConfigure.action?display="+from;
}
