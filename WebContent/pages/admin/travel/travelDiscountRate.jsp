    ...
    <div class="easyui-layout" style="width:900px;height:1000px;">
        ...
        <div data-options="region:'center',title:'',iconCls:''">
            <div class="easyui-tabs" data-options="fit:true,border:false,plain:true" id="mainTab">
                <div title="Discount Rate" style="padding:5px">
								...
								<s:form name="form1" theme="simple">
							 		<table width="100%" align="center">
							        	...
							        	<tr>
			  							...
			  							<tr><td>
								      	<display:table name="list" pagesize="10"  requestURI="${pageContext.request.contextPath}/discountrateTravelConfigure.action" class="table" uid="row" id="record" style="align:center; " cellpadding="1" cellspacing="1"  varTotals="totals" >
										...
										<display:column sortable="true" style="text-align:center;" title="Type" property="TYPE"/>
										<display:column sortable="true" style="text-align:center;" title="Age Start" property="AGE_START"/>
										<display:column sortable="true" style="text-align:center;" title="Age End" property="AGE_END"/>
										...
										<display:column sortable="true"	style="text-align:center;width:10%" title="History" >
		                    					<a href="#" onclick="return popUp('${pageContext.request.contextPath}/discountrateTravelConfigure.action?display=history&drateId=${record.RATE_ID}','400','350');">View</a>
										</display:column>
										<display:column sortable="true" style="text-align:center;" title="Edit"  >
												<input type="button" name="reset" value="Edit" onclick="return fnsubmit(this.form,'edit','${record.RATE_ID}');" class="btn" />
										</display:column>
										</display:table>
										</td></tr>
										<tr><td align="center">
							 			...
							 			<tr>
							 				<td>
							  					<table width="100%" align="center" cellpadding="4" border="0">
								                    ...
								                    <tr>
								                         <td><s:text name="travel.choose.type" /><font color="red">*</font></td>
								                         <td><s:select name="typeList" id="typeList" list="#{'Child':'CHILD','Adult':'ADULT','Infant':'INFANT','Old1':'OLD1','Old2':'OLD2'}" headerKey="" headerValue="-Select-" cssClass="input" /></td>
								                    </tr>
								                    <tr>
								                         <td><s:text name="travel.choose.discount.start" /><font color="red">*</font></td>
								                         <td><s:select name="sageList" id="sageList" list="sage" headerKey="" headerValue="-Select-" cssClass="input" /></td>
								                    </tr>
								                    <tr>
								                         <td><s:text name="travel.choose.discount.end" /><font color="red">*</font></td>
								                         <td><s:select name="eageList" id="eageList" list="eage" headerKey="" headerValue="-Select-" cssClass="input" /></td>
								                    </tr>
							                        <tr>
								                         <td><s:text name="travel.choose.rate.value" /><font color="red">*</font></td>
								                         <td><s:textfield name="rateValue" id="rateValue" cssClass="input" /></td>
								                    </tr>
							                        <tr>
								                         <td><s:text name="travel.core.app.code" /><font color="red">*</font></td>
								                         <td><s:textfield name="drateCode" id="drateCode" cssClass="input" /></td>
								                    </tr>
							                        <tr>
							                             <td><s:text name="travel.effectivedate" /><font color="red">*</font></td>
		                            					 <td><s:textfield name="drateDate"  readonly="true" id="effectiveDt"/></td>
								                    </tr>
									        		<tr>
								                         <td><s:text name="travel.status" /><font color="red">*</font></td>
								                         <td><s:radio list="#{'Y':'Active','N':'DeActive'}" name="drateStatus" id="drateStatus" value="%{drateStatus==null?'N':drateStatus}" cssClass="input2"/></td>
								                    </tr>
								   	  			</table>
							      	  		</td>
							      	  	</tr>
...
{
if(from == 'edit'){
document.form1.action = "${pageContext.request.contextPath}/discountrateTravelConfigure.action?drateId="+val+'&display='+from;
}else{
document.form1.action = "${pageContext.request.contextPath}/discountrateTravelConfigure.action?display="+from;
}
