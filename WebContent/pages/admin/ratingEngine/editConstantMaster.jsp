													...
													<tr>
													  ...
													  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
														...
														<tr>
															...
															<td>
																<s:textfield name="rsacode" id="rsacode" cssClass="inputBox" cssStyle="width:50%;" maxlength="25" onkeypress="return checkAlphaNumeric(event)"/>
															</td>
															<td>&nbsp;</td>																
														</tr>
														<tr>
														...
														<tr>																
															<td colspan="4" align="center">
																<input type="button" class="btn" value="Back" onclick="fnCall('constantMaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn" onclick="return oncheck()"/>
															</td>	
														</tr>	
													 </table></td>
													 </tr>
