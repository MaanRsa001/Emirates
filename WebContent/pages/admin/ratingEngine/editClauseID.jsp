														...
														<tr>
														  ...
														  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
															...
															<tr>
																...
																<td>
																	<s:textarea name="clauseDesc"  maxLength="800" id="clauseDesc" cssClass="inputBoxA" cssStyle="width:50%;" rows="2"/>
																</td>
																<td>&nbsp;</td>
															...
															<tr>
																...
																<td>
																	<s:textarea name="remarks" id="remarks" cssClass="inputBox" cssStyle="width:50%;"  />
																</td>
																<td>&nbsp;</td>
															...
															<tr>
																<td colspan="4" align="center"><input type="button" class="btn" value="Back" onclick="fnCall('clause')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn" onclick="return oncheck()"/></td>
															</tr>																													
														 </table></td>
														 </tr>														
														</table>
