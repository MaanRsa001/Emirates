										...
										<tr align="center">
												 ...
												 <table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
														  ...
														  <tr>
																<td>&nbsp;</td>
																<td><s:text name="exclusion.name"/><font color="red">*</font></td>
																<td>
																	<s:textarea name="exclusionName" cssClass="inputBox" cssStyle="width:50%;"  maxLength="500" onkeyup="allLetter(this);"/>
																</td>
																<td>&nbsp;</td>
															</tr>
															...
															<tr>
																...
																<td colspan="4" align="center">
																	<input type="button" class="btn" value="Back" onclick="fnCall('exclusionmaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn" onclick="return oncheck()"/>
																</td>
															</tr>
														 </table></td>
														 </tr>
