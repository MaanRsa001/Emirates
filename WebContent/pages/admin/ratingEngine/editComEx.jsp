                                                        ...
                                                        <tr>
                                                          ...
                                                          <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="startAmt" id="startAmt" cssClass="inputBox" cssStyle="width:50%;" maxlength="30" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="endAmt" id="endAmt" cssClass="inputBox" cssStyle="width:50%;" maxlength="30" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="deductible" id="deductible" cssClass="inputBox" cssStyle="width:50%;" maxlength="10" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="comExRate" id="conExRate" cssClass="inputBox" cssStyle="width:50%;" maxlength="6" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
                                                            ...
                                                            <tr>
                                                                <td colspan="4" align="center"><input type="button" class="btn" value="Back" onclick="fnCall('commodityexcess')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn" onclick="return oncheck()"/></td>
