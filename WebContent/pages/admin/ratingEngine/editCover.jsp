                                                          ...
                                                          <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <s:if test='"edit".equalsIgnoreCase(mode)'>
                                                                   <s:select name="transID" id="transID" list="transports" listKey="MODE_TRANSPORT_ID" listValue="TRANSPORT_DESCRIPTION" headerKey="-1"  headerValue="-Select-" cssClass="inputSelect" cssStyle="width: 51%;" disabled="true"/>
                                                                   <s:hidden name="transID" id="transID"/>
                                                                </s:if>
                                                                <s:else>
                                                                   <s:select name="transID" id="transID" list="transports" listKey="MODE_TRANSPORT_ID" listValue="TRANSPORT_DESCRIPTION" headerKey="-1"  headerValue="-Select-" cssClass="inputSelect" cssStyle="width: 51%;" />
                                                                </s:else>
                                                                </td>
                                                                <td>&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="coverName" cssClass="inputBox" cssStyle="width:50%;" size="35"/>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="coverDesc" cssClass="inputBox" cssStyle="width:50%;" size="35"/>
                                                                </td>
                                                                <td>&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="coverRate" cssClass="inputBox" cssStyle="width:50%;" size="35" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
                                                                </td>
                                                                <td>&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="code" cssClass="inputBox" cssStyle="width:50%;" size="35" onkeypress="return checkAlphaNumeric(event)"/>
                                                                </td>
                                                                <td>&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <s:textfield name="remarks" cssClass="inputBox" cssStyle="width:50%;" size="35" />
                                                                </td>
                                                                <td>&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <td colspan="4" align="center">
                                                                    <input type="button" class="btn" value="Back" onclick="fnCall('covermaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn"/>
                                                                </td>
                                                            </tr>
                                                         </table></td>
                                                         </tr>
