       ...
       <div data-options="region:'west',split:true" title="Options" style="width:150px;">
        ...
        <div data-options="region:'center',title:'',iconCls:''">
            <div class="easyui-tabs" data-options="fit:true,border:false,plain:true" id="mainTab">
                <div title="Sale Term Master" style="padding:5px">
                <s:form id="info" name="info" method="post" action="updateSaleRating.action" theme="simple">
                    <table width="100%">
                          <tr>
                            <td height="5"></td>
                          </tr>
                              ...
                              <tr>
                                <td bgcolor="#FFFFFF" style="padding:10px; background:#F8F8F8">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr> <td>&nbsp;&nbsp;</td> </tr>
                                        <tr><td class="heading"><s:text name="sale.name"/></td></tr>
                                        <tr><td>&nbsp;</td></tr>
                                        <tr align="center">
                                                 <td bgcolor="#FFFFFF">
                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                          ...
                                                          <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                                <td>
                                                                    <s:text name="sale.name.value"/><font color="red">*</font>
                                                                </td>
                                                                <td>
                                                                    <s:textfield name="saleName" cssClass="inputBox" cssStyle="width:50%;" id="saleName" maxlength="25"/>
                                                            ...
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                                <td>
                                                                    <s:text name="sale.value"/><font color="red">*</font>
                                                                </td>
                                                                <td>
                                                                    <s:textfield name="saleValue" cssClass="inputBox" cssStyle="width:50%;" id="saleValue" maxlength="6" onkeypress="return fun_AllowOnlyAmountAndDot(this.id)"/>
                                                            ...
                                                            <tr>
                                                                <td colspan="4" align="center"><input type="button" class="btn" value="Back" onclick="fnCall('saletermmaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn" onclick="return oncheck()"/></td>
