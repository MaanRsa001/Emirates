       ...
       <div data-options="region:'west',split:true" title="Options" style="width:150px;">
        ...
        <div data-options="region:'center',title:'',iconCls:''">
            <div class="easyui-tabs" data-options="fit:true,border:false,plain:true" id="mainTab">
                <div title="Exchange Master" style="padding:5px">
                <s:form id="info" name="info" method="post" action="updateExchangeRating.action" theme="simple">
                    <table width="100%">
                          <tr>
                            <td height="5"></td>
                          </tr>
                              ...
                              <tr>
                                <td bgcolor="#FFFFFF" style="padding:10px; background:#F8F8F8">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr> <td>&nbsp;&nbsp;</td> </tr>
                                        <tr><td class="heading"><s:text name="exchange.master"/></td></tr>
                                        <tr><td>&nbsp;</td></tr>
                                        <tr align="center">
                                                 <td bgcolor="#FFFFFF">
                                                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                          ...
                                                          <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                <s:select list="exchanges" id="currencyID" name="currencyID" headerKey="-1" headerValue="-- Select --" listKey="CURRENCY_ID" listValue="CURRENCY_NAME" cssClass="inputSelect" cssStyle="width: 51%;" />
                                                                </td>
                                                                <td>&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                                <td><s:text name="exchange.rate"/><font color="red">*</font></td>
                                                                <td>
                                                                    <s:textfield name="exchangeRate" id="exchangeRate" cssClass="inputBox" cssStyle="width:50%;" maxlength="15" onkeypress="return fun_AllowOnlyAmountAndDotSix(this.id)"/>
                                                                </td><s:hidden name="amendID"/><s:hidden name="exchangeID"/>
                                                                <td>&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td>&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="4" align="center">
                                                                    <input type="button" class="btn" value="Back" onclick="fnCall('exchangemaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn" onclick="return oncheck()"/>
                                                                </td>
                                                            </tr>
                                                         </table></td>
                                                         </tr>
