       ...
       <div data-options="region:'west',split:true" title="Options" style="width:150px;">
        ...
        <div data-options="region:'center',title:'',iconCls:''">
            <div class="easyui-tabs" data-options="fit:true,border:false,plain:true" id="mainTab">
                <div title="Currency Master" style="padding:5px">
                <s:form id="info" name="info" method="post" action="updateCurrencyRating.action" theme="simple">
                	<table width="100%">
                          <tr>
						    <td height="5"></td>
						  </tr>
						      ...
						      <tr>
						        <td bgcolor="#FFFFFF" style="padding:10px; background:#F8F8F8">
						            ...
						            <table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr> <td>&nbsp;&nbsp;</td> </tr>
										<tr><td class="heading"><s:text name="currency.master"/></td></tr>
										<tr><td>&nbsp;</td></tr>
										<tr align="center">
												 <td bgcolor="#FFFFFF">
												 <table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
														  ...
														  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0">
															...
															<tr>
																<td>&nbsp;</td>
																<td><s:text name="currency.type"/> <font color="red">*</font></td>
																<td>
																	<s:textfield name="currencyType" id="currencyType" cssClass="inputBox" cssStyle="width:50%;" maxlength="25" onkeyup="allLetter(this);"/>
																</td>
																<td>&nbsp;</td>
															...
															<tr>
																<td>&nbsp;</td>
																<td><s:text name="currency.rfactor"/> <font color="red">*</font></td>
																<td>
																	<s:textfield name="rfactor" id="rfactor" cssClass="inputBox" cssStyle="width:50%;"  maxlength="1" onkeypress="return isNumberKey(this);"/>
																</td>
																<td>&nbsp;</td>
															...
															<tr>
																<td>&nbsp;</td>
																<td><s:text name="currency.subCurrency"/> <font color="red">*</font>	</td>
																<td>
																	<s:textfield name="subCurrency" id="subCurrency" cssClass="inputBox" cssStyle="width:50%;" maxlength="10" onkeyup="allLetter(this);"/>
																</td>
																<td>&nbsp;</td>
															...
															<tr>
																<td>&nbsp;</td>
																<td><s:text name="currency.shortname"/> <font color="red">*</font></td>
																<td> 
																	<s:textfield name="currencyShortName" id="currencyShortName" cssClass="inputBox" cssStyle="width:50%;" maxlength="25" onkeyup="allLetter(this);"/>
																</td><s:hidden name="currencyID"/><s:hidden name="amendID"/>
																<td>&nbsp;</td>
															...
															<tr>
																...
																<td colspan="4" align="center">
																	<input type="button" class="btn" value="Back" onclick="fnCall('currencymaster')"/>&nbsp;&nbsp;<s:submit value="Save" cssClass="btn" onclick="return oncheck()"/>
																</td>
															</tr>
														 </table></td>
														 </tr>
