		        		...
		        		<td bgcolor="#FFFFFF" style="padding:10px; background:#F8F8F8">
								<s:form name="form1" theme="simple">
							 		<table width="100%" align="center">
								        <tr>
								            <td class="heading" width="100%"><s:text name="label.commodity.selection"/></td>
								        </tr>
								 		<tr>
								        	<td height="10%">
								        		&nbsp;
							      		...
							      		<tr>
							      			<td>
										      	<display:table name="commodityList" requestURI="commoditySelectAreport.action" pagesize="" class="table" uid="row" id="record">
													...
													<%--
													<display:column headerClass="sortable" style="text-align:center;" title="<input type='checkbox'  onclick='SelectAll()' id='checkall' />">
														 <input type="checkbox"  value="${record.commodity_id}" id="checkbox${record.commodity_id}" />
													</display:column>
													--%>
													<display:column headerClass="sortable" style="text-align:center;" >
														<input type="checkbox"  value="${record.commodity_id}" id="checkbox${record.commodity_id}" />
													</display:column>
													<display:column headerClass="sortable" style="text-align:left;" title="Commodity Name" property="commodity_name" />
												</display:table>
											</td>
										</tr>
