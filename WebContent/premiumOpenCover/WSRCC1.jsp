...
<%
   ...
   %>
	...
	<tr> 
	<td height="17" colspan="7" class="blueborder" align="left">&nbsp;&nbsp;&nbsp;<strong>WSRCC SUMMARY </strong></td>
	</tr>
	<tr> 
	<td colspan="7">&nbsp;</td>
	</tr>
	...
	<td width="500" align="left"><strong>Opted WSRCC </strong></td>
	</tr>
...
<tr> 
<td align="center"><a href="#" onClick="return back()"  >
<img src="../images/Back.jpg" ></a> </td>
<td>&nbsp;</td>
<td align="center">
<a href="#" onClick="reDirectMe('submitt','<%=i%>')"  >
...
function back()
{
	document.clauses.action="WSRCC.jsp";
...
function reDirectMe(value,i)
{
	...
	if(value='submitt')
	{
		...
		{
			eval("window.opener.document.form1.wsrcc_clauses.value="+i);
			var r = eval("window.opener.document.form1.wsrcc_clauses.value");
		}
		else
		{
