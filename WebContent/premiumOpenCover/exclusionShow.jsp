...
<%
	...
	//out.println("Todday is"+todayStr);
%>
<html>
<script>
function controls()
...
<%
	...
	session.setAttribute("coverNo", co);
	...
	totalConditions=ct.getExclusionsFromMaster(belongingBranch);
	...
	if(isErrorPage) {
       ...
       //{
		selectedAddons=(HashMap)ct.getExclusionFromOpenCoverMaster();
	}    
%>
<table  align="center" border="0" cellpadding="2" cellspacing="2" width="100%">
	<tr>
		<td>
			<span class="heading">Exclusions</span>
		</td>
	</tr>
</table>
<table  align="center" border="0" cellpadding="2" cellspacing="2" width="100%">
...
<table class="footable" width="100%">
	...
	<tr>
		<th>
			...
			<input type="hidden" name="exclusionNoEDIT" value="2" />
		</th>
		<th>Exclusion ID</th>
...
<%
	...
	if(conditionsList.size()>0) {
		for(int k=0;k<conditionsList.size();k++) {
			...
			}catch(Exception e) {System.out.println("Exclusionshow.jsp..."+e);e.printStackTrace();}				
...
<div align="right">
	...
	<%--Effective Date <input readOnly value="<%=(effectDate==""?todayStr:effectDate	)%>" name="effectDate" size="20" type="text" class="fde1">
	<a href="javascript:cal6.popup();"><img alt="Click Here Pick up the date" src="../images/cal.gif" border="0" width="16" height="16"></a> --%>
</div>
<%}%>
<div align="center" style="margin-top: 10px;">
	<a href="javascript:window.close()"  class="buttonsMenu" > <img src="../images/Back.jpg" ></a>
	&nbsp;&nbsp;&nbsp;
	<a href="#" onClick="formSubmit()" class="buttonsMenu" > <img src="../images/Proceed.jpg"> </a>
</div>
</form>
</body>
