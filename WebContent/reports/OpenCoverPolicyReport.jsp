...
String[][] policyDetails=com.getOpenCoverPolicyDetails(startdate,enddate,product,branch);
...
<table width="90%" style="margin: 0 auto;">
	...
	<tr>
		<td><div class="heading">OPENCOVER POLICY REPORT</div></td>
	</tr>
	<tr height="5"><td></td></tr>
	<tr>
		<td>
			<table width="75%" style="margin: 0 auto;">
				<tr>
					<td colspan="2" align="center">OPENCOVER POLICY INTEGRATION REPORT</td>
				</tr>
